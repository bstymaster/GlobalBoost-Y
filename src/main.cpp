...
#if defined(NDEBUG)
# error "Globalboost-Y cannot be compiled without assertions."
#endif
...
static const int64 nTargetTimespan = 24*60*60; // Globalboost: 24hrs
...
void ThreadScriptCheck() {
    RenameThread("globalboost-y-scriptch");
...
bool LoadBlockIndex()
{
    if (fTestNet)
    {
        ...
        pchMessageStart[2] = 't';
        pchMessageStart[3] = 'y';
        hashGenesisBlock = uint256("0x2e28050194ad73f2405394d2f081361a23c2df8904ec7f026a018bbe148d5adf");
    }
...
bool InitBlockIndex() {
   ...
   // fTxIndex = GetBoolArg("-txindex", false);
    ...
    if (!fReindex) {
        ...
        assert(block.hashMerkleRoot == uint256("0xacd715d33d3288f616bfe281819a4d84bdea206b8c06088eec584095f5de891c"));
        block.print();
...
unsigned char pchMessageStart[4] = { 0xa2, 0xb2, 0xe2, 0xf2 }; // 
